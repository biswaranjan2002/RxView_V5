...
public class InfantController {
    ...
    private static InfantController instance = new InfantController();
    public static InfantController getInstance(){
        return instance;
    }
    ...
    public void loadAllRadioButtons() {
        ...
        ArrayList<CategoryBodyPartsEntity> selectedBodyParts = categoryBodyPartsService.getAllSelectedBodyParts("infant");
    ...
    private final Logger logger = LoggerFactory.getLogger(InfantController.class);
