...
public class ManController {
    ...
    public void loadAllRadioButtons() {
        ...
        ArrayList<CategoryBodyPartsEntity> selectedBodyParts = categoryBodyPartsService.getAllSelectedBodyParts("male");
    ...
    private final Logger logger = LoggerFactory.getLogger(ManController.class);
    ...
    public JFXButton createProjectionButton(String stepName, File imageFile,String page) {
    ...
    public JFXButton createSelectedProjectionButton(String stepName, File imageFile,JFXButton projectionButton) {
        JFXButton button = new JFXButton(stepName);
