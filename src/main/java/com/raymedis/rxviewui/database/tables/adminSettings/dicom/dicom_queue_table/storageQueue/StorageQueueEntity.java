...
public class StorageQueueEntity {
    ...
    //constructors
    public StorageQueueEntity() {
    }

    public StorageQueueEntity(int id, String state, LocalDateTime examDateTime, String patientName, String patientId) {
        this.id = id;
        this.state = state;
