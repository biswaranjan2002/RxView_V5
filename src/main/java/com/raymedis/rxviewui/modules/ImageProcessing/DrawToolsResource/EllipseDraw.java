...
public class EllipseDraw implements IDrawTools{
    ...
    public EllipseDraw(Canvas theCanvas, Point2D point){
    ...
    public void handleCanvasReleased(MouseEvent event) {
        if (isDrawing) {
            ...
            if(ellipse == null && startX != x && startY != y){
                ...
                CanvasMainChange.addEllipseDraw(ellipse);
                drawEllipse();
    ...
    public void removeAll() {
        CanvasMainChange.removeEllipseDraw(ellipse);
        ellipse = null;
        isComplete = true;
    }
