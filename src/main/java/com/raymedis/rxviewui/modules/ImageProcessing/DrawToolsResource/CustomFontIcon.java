...
public class CustomFontIcon {
    ...
    private final Logger logger = LoggerFactory.getLogger(CustomFontIcon.class);

    public CustomFontIcon(double x, double y, Color color, Canvas canvas) {

        iconSize = DynamicCanvasElementsResize.getCustomFontIconSize();
